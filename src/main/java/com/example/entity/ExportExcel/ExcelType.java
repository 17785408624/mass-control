...
public enum ExcelType {
    ...
    UserInfoAudit_Expert(
            2,
            new String[]{"用户编号", "用户手机号", "学历", "申请时间", "用户注册时间", "专家名", "身份证号", "所学专业", "从事专业", "申报专业-技术报告咨询审查类", "申报专业-安全生产检查类","审核状态"},
            "初审审核-专家用户信息",
            "expertDate"),
    ...
    UserInfoAudit_NotRefer_Expert(
            4,
            new String[]{"用户编号", "用户手机号", "学历", "申请时间", "用户注册时间", "专家名", "身份证号", "所学专业", "从事专业", "申报专业-技术报告咨询审查类","申报专业-安全生产检查类"},
            "初审审核-未审核的专家用户信息",
            "expertDate"),
